...
_cgiBinPath(std::string(DEFAULT_CGI_PATH)), _cgiExtension(std::string(DEFAULT_CGI_EXT)) {std::cerr << this << ": location created\n"; }

Location::~Location() {std::cerr << this << ": location destroyed\n";}
